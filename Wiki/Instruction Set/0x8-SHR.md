...
0x0: Ra Rb: Rb (Shifted R[Ra]<3...0> times) -> Rb
    ...
    5) NOP                                      | NOP 
    6) (n != 0 AND ALT = 0): Y SHR -> Y; n--    | SHR Yout Yin SCdec GOTO6
       (n != 0 AND ALT = 1): Y SHL -> Y; n--    | SHL Yout Yin SCdec GOTO6
...
0x2: #N Rb: Rb (Shifted #N times) -> Rb
    ...
    6) (n != 0 AND ALT = 0): Y SHR -> Y; n--    | Yout Yin SHR SCdec GOTO6
       (n != 0 AND ALT = 1): Y SHL -> Y; n--    | Yout Yin SHL SCdec GOTO6
